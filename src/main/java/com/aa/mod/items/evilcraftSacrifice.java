...
public class evilcraftSacrifice extends DaggerOfSacrifice {
  private float weaponDamage;

  public evilcraftSacrifice() {
    this.maxStackSize = 1;
    ...
    this.setUnlocalizedName("evilcraftSacrifice");
    this.setTextureName("arcanearteries:" + this.getUnlocalizedName().substring(5));
  }

  @SideOnly(Side.CLIENT)
  public void registerIcons(IIconRegister iconRegister) {
    this.itemIcon = iconRegister.registerIcon("arcanearteries:evilcraftSacrifice");
  }
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(StatCollector.translateToLocal("Something so evil must be fun"));
    par3List.add(StatCollector.translateToLocal("Turning monsters to blood must be done!"));
  }
}
