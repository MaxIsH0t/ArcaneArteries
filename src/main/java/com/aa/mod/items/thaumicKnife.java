...
public class thaumicKnife extends SacrificialDagger {
  ...
  public void registerIcons(IIconRegister iconRegister) {
    if (AlchemicalWizardry.wimpySettings) {
      ...
      this.itemIcon = iconRegister.registerIcon("arcanearteries:thaumicKnife");
    }
  ...
  public String getItemStackDisplayName(ItemStack stack) {
    return AlchemicalWizardry.wimpySettings ? "Thaumic Orb" : super.getItemStackDisplayName(stack);
  }
